  ...
  return (
     <Dialog.Portal>
        ...
        <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25" >
          <Dialog.Title className="text-3xl font-black" >Publique um anúncios</Dialog.Title>
          ...
          <label className='mt-2 flex gap-2 text-sm items-center' >
            <Checkbox.Root 
              ...
              onCheckedChange={(cheked) => cheked === true ? setUseVoiceChannel(true) : setUseVoiceChannel(false)}
            >
              <Checkbox.Indicator>
